...
import { createExpandedPromise } from "./expanded-promise.js";
...
export default drizzle => (
  ...
  // TODO: figure out how to only trigger when a deep comparison of eventOptionsArgs returns false. Until then, users
  // should rely on useMemo to prevent eventsOptionsFn and eventOptionsArgs from changing.
  useEffect(() => {
    let mounted = true;
    let listener;
    ...
    Promise.all(eventOptionsArgs === undefined ? [] : eventOptionsArgs).then(
      eventOptionsArgsResolved => {
